...
|-------|----------|---------------|--------------|-----------------|
| 💚 **Básico** | Gemini 2.5 Pro (Reasoning) + Modelo Complementar Leve/Rápido | 100 msg/dia | R$ 79,90 | Ideal para uso pessoal básico |
...
- **Básico (R$ 79,90)**: Gemini 2.5 Pro ~5.000 tokens/msg × 100 msg = custo ~R$ 50 + infraestrutura
